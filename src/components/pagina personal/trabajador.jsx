  ...
  return (
    <div className="w-full relative h-96 md:w-10/12 lg:w-4/12 m-5 md:h-4/12 mt-9 md:mt-0 bg-white/5  rounded-2xl shadow-xl flex flex-col">
      ...
      <div className="h-1/2 flex rounded-t-lg  rounded-b-2xl ">
        {/* Caja imagen */}
        <div className="flex border-2 flex-wrap w-1/4 justify-center items-center rounded-lg bg-violet-500/50">
          {/* <img
        ...
        <div className="w-3/4 h-full flex flex-wrap">
          ...
          <div className="w-1/2 h-1/3 flex flex-col">
            ...
            <p className="text-center text-xs ">{worker.id}</p>
          </div>
        </div>
      </div>
      ...
      <div className="h-1/2 flex flex-col rounded-b-lg">
        ...
        <div className="h-full w-full flex flex-wrap">
          ...
          <div className="w-1/2 md:w-1/3 flex flex-col items-center">
            ...
            <p className="text-xs ">$ 32014</p>
          </div>
          <div className="w-1/2 md:w-1/3 flex flex-col items-center">
            <h4 className="text-xs  font-serif font-semibold">
              general
            </h4>
            <p className="text-xs ">$ 84210</p>
          </div>
        </div>
      </div>
    </div>
