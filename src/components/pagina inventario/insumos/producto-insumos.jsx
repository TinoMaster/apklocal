      ...
      {!modalEditar ? (
        ...
        <div className=" w-1/3 text-center text-zinc-500 border-x-2 p-2">
          <input
            ...
            name="nombre"
            type="text"
            className="w-full h-full text-xs md:text-sm text-center hover:outline-none focus:outline-none"
          />
        </div>
      )}
      ...
      {!modalEditar ? (
        <div className="relative w-1/3 flex text-center">
          ...
          {!botonEditOff && (
            <div
              ...
              className="absolute -right-2 text-slate-500 hover:text-slate-800 border-l-2 rounded-lg h-full bg-slate-50 hover:cursor-pointer hover:bg-teal-400/50 w-10 flex flex-col justify-center items-center text-center"
            >
        ...
        <div className="relative w-1/3 flex text-center border-x-2">
          <input
            ...
            name="local"
            type="number"
            className="w-full h-full text-xs md:text-sm text-center hover:outline-none focus:outline-none text-zinc-500"
          />
          <div
            onClick={() => {
            ...
            className="absolute right-0 border-l-2 rounded-lg h-full bg-slate-50 hover:cursor-pointer hover:bg-yellow-400/40 w-10 flex flex-col justify-center items-center text-center"
          >
            <FontAwesomeIcon
