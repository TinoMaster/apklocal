...
const CajaCuadre = ({
  ...
  return (
    <div className="w-full max-w-4xl relative h-full items-center sm:w-9/12 m-auto justify-center md:w-5/12 flex flex-col">
      {errorsForm && (
      ...
      <form
        action=""
        className="flex flex-col w-10/12 h-full md:h-5/6 shadow-lg  mt-16 md:mt-0 rounded-lg md:w-3/4 mb-10 md:mb-0"
      >
        ...
        <div className="flex w-full border-t-2 bg-slate-100 border-slate-300 justify-center p-4 rounded-xl">
          <input
            type="button"
            className="text-white text-sm font-sans shadow-lg px-3 py-1 mr-3 rounded-xl shadow-teal-500/60 font-semibold bg-teal-400 hover:bg-teal-500 hover:cursor-pointer hover:shadow-teal-600"
            onClick={handleSubmitForm}
            value="Terminar"
          />
          <input
            type="reset"
            className="text-white text-sm font-sans shadow-lg px-3 py-1 ml-3 rounded-xl shadow-slate-500/60 font-semibold bg-slate-500 hover:bg-slate-600 hover:cursor-pointer hover:shadow-slate-600"
